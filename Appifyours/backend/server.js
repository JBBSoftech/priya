...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/priya_app', {
...
app.get('/api/app-config', async (req, res) => {
  try {
    ...
    const config = {
      adminId: '6954c15c7b955a47cbd65b36',
      shopName: 'priya',
...
app.listen(PORT, () => {
  console.log(`priya Backend Server running on port ${PORT}`);
});
